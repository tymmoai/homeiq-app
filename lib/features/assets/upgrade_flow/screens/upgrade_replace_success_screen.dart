...
class _UpgradeReplaceSuccessScreenState
  ...
  void initState() {
    super.initState();
    _claimId = 'RPL-${DateTime.now().millisecondsSinceEpoch.toString().substring(7)}';
        ...
        return Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                widget.assetType,
                style: TextStyle(fontSize: responsive.fontSize(12), color: _textSecondary),
              ),
              ...
              Row(
                children: [
                  Icon(Icons.hourglass_top, size: responsive.iconSize(18), color: _headerColor),
      ...
      body: SafeArea(child: Stack(
        children: [
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          Icon(Icons.phone, size: responsive.iconSize(14), color: AppColors.warningOrange),
                          SizedBox(width: responsive.spacing(6)),
                          Text(
                      ...
                      Row(
                        children: [
                          Icon(Icons.email, size: responsive.iconSize(14), color: AppColors.warningOrange),
                          SizedBox(width: responsive.spacing(6)),
                          Text(
                  ...
                  children: [
                    ...
                    SizedBox(
                      ...
                      child: ElevatedButton.icon(
                        ...
                        icon: Icon(Icons.receipt_long, size: responsive.iconSize(20)),
                        label: Text(
                          'View Full Details',
                          style: TextStyle(
                    ...
                    SizedBox(
                      ...
                      child: ElevatedButton.icon(
                        ...
                        icon: Icon(Icons.track_changes, size: responsive.iconSize(20)),
                        label: Text(
                          'Track My Claims',
                          style: TextStyle(
                            fontSize: responsive.fontSize(15),
                    ...
                    SizedBox(
                      ...
                      child: OutlinedButton.icon(
                        ...
                        icon: Icon(Icons.arrow_back, size: responsive.iconSize(20)),
                        label: Text(
                          'Back to Asset',
                          style: TextStyle(
                            fontSize: responsive.fontSize(15),
          ...
          Positioned(
            ...
            right: 20,
            child: IconButton(
              icon: Icon(Icons.close, color: AppColors.textPrimary, size: responsive.iconSize(28)),
              onPressed: () {
