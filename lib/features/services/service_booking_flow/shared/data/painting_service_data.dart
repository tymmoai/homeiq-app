...
class PaintingServiceData {
  ...
  static final List<ServiceCategory> categories = [
    ...
    const ServiceCategory(
      ...
      items: [
        ServiceItem(
          name: 'Small Room (≤100 sqft)',
          price: 150,
          icon: Icons.crop_square_outlined,
        ),
        ServiceItem(
          name: 'Medium Room (100-200 sqft)',
          price: 225,
          icon: Icons.crop_square_outlined,
        ),
        ServiceItem(
          name: 'Large Room (200-350 sqft)',
          price: 300,
          icon: Icons.crop_square_outlined,
        ),
        ServiceItem(
          name: 'Extra Large Room (350+ sqft)',
          price: 375,
          icon: Icons.crop_square_outlined,
        ),
      ],
    ...
    const ServiceCategory(
      ...
      items: [
        ServiceItem(
          name: 'Small Kitchen (≤10 cabinets)',
          price: 400,
          icon: Icons.kitchen_outlined,
        ),
        ServiceItem(
          name: 'Medium Kitchen (10-20 cabinets)',
          price: 640,
          icon: Icons.kitchen_outlined,
        ),
        ServiceItem(
          name: 'Large Kitchen (20-30 cabinets)',
          price: 880,
          icon: Icons.kitchen_outlined,
        ),
        ServiceItem(
          name: 'Full Kitchen (30+ cabinets)',
          price: 1200,
          icon: Icons.kitchen_outlined,
        ),
      ],
    ...
    const ServiceCategory(
      ...
      items: [
        ServiceItem(
          name: 'Minor (1-2 areas)',
          price: 75,
          icon: Icons.brush_outlined,
        ),
        ServiceItem(
          name: 'Moderate (3-5 areas)',
          price: 113,
          icon: Icons.brush_outlined,
        ),
        ServiceItem(
          name: 'Extensive (6+ areas)',
          price: 150,
          icon: Icons.brush_outlined,
        ),
      ],
  ...
  static const List<ServiceAddon> addons = [
    ServiceAddon(
      name: 'Minor Wall Repair',
      price: 35,
      icon: Icons.construction_outlined,
      description: 'Fix small holes and cracks',
    ),
    ServiceAddon(
      name: 'Putty Application',
      price: 25,
      icon: Icons.auto_fix_high_outlined,
      description: 'Fill and smooth imperfections',
    ),
    ServiceAddon(
      name: 'Primer Coat',
      price: 45,
      icon: Icons.format_paint_outlined,
      description: 'Premium primer for better coverage',
    ),
    ServiceAddon(
      name: 'Furniture Covering',
      price: 20,
      icon: Icons.layers_outlined,
      description: 'Protect furniture and floors',
    ),
    ServiceAddon(
      name: 'Old Paint Removal',
      price: 75,
      icon: Icons.layers_clear_outlined,
      description: 'Strip old paint before new coat',
    ),
    ServiceAddon(
      name: 'Ceiling Painting',
      price: 60,
      icon: Icons.crop_square_outlined,
      description: 'Include ceiling in the job',
    ),
  ];
