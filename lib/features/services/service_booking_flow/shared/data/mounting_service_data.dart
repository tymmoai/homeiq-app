...
class MountingServiceData {
  ...
  static const List<ServiceAddon> addons = [
    ServiceAddon(
      name: 'Heavy-Duty Wall Anchoring',
      price: 25,
      icon: Icons.shield_outlined,
      description: 'Secure anchoring for heavy items',
    ),
    ServiceAddon(
      name: 'Existing Item Removal',
      price: 35,
      icon: Icons.delete_sweep_outlined,
      description: 'Remove old mount/item from wall',
    ),
    ServiceAddon(
      name: 'Cable Concealment',
      price: 75,
      icon: Icons.cable_outlined,
      description: 'Hide cables neatly (TV Mounting)',
    ),
    ServiceAddon(
      name: 'Extra Hardware Kit',
      price: 20,
      icon: Icons.hardware_outlined,
      description: 'Additional screws, anchors, brackets',
    ),
    ServiceAddon(
      name: 'Extra Helper',
      price: 45,
    ...
    ServiceAddon(
      name: 'Multi-Point Level Alignment',
      price: 30,
      icon: Icons.straighten_outlined,
      description: 'Precision leveling across multiple points',
    ),
  ];
  ...
  static final List<ServiceCategory> categories = [
    ...
    const ServiceCategory(
      ...
      items: [
        ServiceItem(
          name: 'Small Frame (up to 11x14")',
          price: 15,
          icon: Icons.photo_outlined,
        ),
        ServiceItem(
          name: 'Medium Frame (16x20 to 24x36")',
          price: 25,
          icon: Icons.photo_outlined,
        ),
        ServiceItem(
          name: 'Large Frame (over 24x36")',
          price: 40,
          icon: Icons.photo_outlined,
        ),
        ServiceItem(
        ...
        ServiceItem(
          name: 'Gallery Wall (3-5 pieces)',
          price: 75,
          icon: Icons.grid_view_outlined,
        ),
        ServiceItem(
          name: 'Gallery Wall (6-10 pieces)',
          price: 125,
          icon: Icons.grid_view_outlined,
        ),
      ],
    ...
    const ServiceCategory(
      ...
      items: [
        ServiceItem(
          name: 'Small Mirror (up to 24")',
          price: 45,
          icon: Icons.crop_square_outlined,
        ),
        ServiceItem(
          name: 'Medium Mirror (24-36")',
          price: 65,
          icon: Icons.crop_square_outlined,
        ),
        ServiceItem(
          name: 'Large Mirror (36-48")',
          price: 89,
          icon: Icons.crop_square_outlined,
        ),
        ServiceItem(
    ...
    const ServiceCategory(
      ...
      items: [
        ServiceItem(
          name: 'Floating Shelf Small (up to 24")',
          price: 29,
          icon: Icons.shelves,
        ),
        ServiceItem(
          name: 'Floating Shelf Medium (24-36")',
          price: 39,
          icon: Icons.shelves,
        ),
        ServiceItem(
          name: 'Floating Shelf Large (36"+)',
          price: 49,
          icon: Icons.shelves,
        ),
    ...
    const ServiceCategory(
      ...
      items: [
        ServiceItem(
          name: 'Standard Curtain Rod',
          price: 35,
          icon: Icons.window_outlined,
        ),
        ServiceItem(
          name: 'Double Curtain Rod',
          price: 49,
          icon: Icons.window_outlined,
        ),
        ServiceItem(
          name: 'Extra Long Curtain Rod',
          price: 59,
          icon: Icons.window_outlined,
        ),
        ServiceItem(
    ...
    const ServiceCategory(
      ...
      items: [
        ServiceItem(
          name: 'Wall Cabinet Small',
          price: 75,
          icon: Icons.kitchen_outlined,
        ),
        ServiceItem(
          name: 'Wall Cabinet Large',
          price: 99,
          icon: Icons.kitchen_outlined,
        ),
        ServiceItem(
          name: 'Base Cabinet Small',
          price: 89,
          icon: Icons.kitchen_outlined,
        ),
        ServiceItem(
          name: 'Base Cabinet Large',
          price: 119,
          icon: Icons.kitchen_outlined,
        ),
        ServiceItem(
