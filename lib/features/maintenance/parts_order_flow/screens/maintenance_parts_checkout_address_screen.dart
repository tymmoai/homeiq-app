...
class MaintenancePartsCheckoutAddressScreen extends StatefulWidget {
  ...
  @override
  State<MaintenancePartsCheckoutAddressScreen> createState() => _MaintenancePartsCheckoutAddressScreenState();
}

class _MaintenancePartsCheckoutAddressScreenState extends State<MaintenancePartsCheckoutAddressScreen> {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Row(
          ...
          children: [
            Icon(Icons.auto_fix_high, size: responsive.iconSize(20), color: AppColors.headerForeground),
            ...
            children: [
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    ...widget.parts.asMap().entries.where((entry) => widget.selectedParts[entry.key]).map((entry) {
              ...
              Container(
                ...
                child: TextFormField(
                  ...
                  contentPadding: EdgeInsets.symmetric(horizontal: responsive.spacing(12), vertical: responsive.spacing(14)),
                  filled: true,
              ...
              Container(
                ...
                child: Row(
                  children: [
                    Icon(Icons.local_shipping, size: responsive.iconSize(20), color: AppColors.textSecondary),
                    SizedBox(width: responsive.spacing(8)),
                    Expanded(
                      child: Text(
