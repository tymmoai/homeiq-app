...
class _SignUpScreenState extends State<SignUpScreen> {
  ...
  void initState() {
    ...
    _fullNameController.addListener(_clearNameErrorIfValid);
  }
  ...
  /// Clear name error only if it was shown AND the name is now valid
  void _clearNameErrorIfValid() {
    if (_nameError == null || !_hasAttemptedValidation) return;
  ...
  /// Validate both fields (called only on Continue button click)
  ...
  bool get canContinue => !_isSubmitting;
